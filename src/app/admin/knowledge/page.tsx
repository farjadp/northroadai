...
function FilesView() {
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (failCount > 0) {
            alert(`Completed with issues: ${successCount} uploaded, ${failCount} failed.`);
        } else {
        ...
        <div className="space-y-6">
            <div className="border-2 border-dashed border-white/10 rounded-2xl p-8 text-center hover:border-cyan-500/50 transition-colors bg-white/5 group">
                ...
                <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center gap-4">
                    ...
                    <div><p className="text-white font-bold text-lg">Upload Global Playbooks (Multi-File)</p></div>
                </label>
            </div>
